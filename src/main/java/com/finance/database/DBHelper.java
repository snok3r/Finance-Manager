...
public class DBHelper implements DataStore {
    ...
    private class SQLFileExecution {
        /**
         * Executes sql query from the <tt>fileName</tt>
         *
         * @param fileName fileName to the file with sql query
        ...
        public boolean executeSQL(String fileName) throws IOException, SQLException {
            ...
            try {
                ...
                log.log(Level.WARNING, "Failed to Execute " + fileName + ". The error is ", e);
            }
            return success;
        }
    }
